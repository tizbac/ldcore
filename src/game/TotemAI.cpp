...
TotemAI::UpdateAI(const uint32 /*diff*/)
{
        ...
        i_totem.IsFriendlyTo(victim) || !victim->isVisibleForOrDetect(&i_totem,false) )
    {
        ...
        cell.Visit(p, grid_object_checker,  *MapManager::Instance().GetMap(i_totem.GetMapId(), &i_totem));
        cell.Visit(p, world_object_checker, *MapManager::Instance().GetMap(i_totem.GetMapId(), &i_totem));
    }
