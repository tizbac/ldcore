...
class TRINITY_DLL_SPEC Aura
{
    ...
    public:
        ...
        bool   SkipBreakChance() { if(m_skipBreakChance){ m_skipBreakChance = false; return true;} return false;};
        ...
        bool IsDualStack() { return m_canDualStack;};
        bool IsActiveDualStack() { return m_activeDualStack;};
        void SetActiveDualStack(bool val) { m_activeDualStack = val;};
        bool IsForceStack(){ return m_forceSingleStack;};
        void SetForceStack(bool val){ m_forceSingleStack = val;};
        ...
        void  SetPeriodicTimer(int32 val) { m_periodicTimer = val;};
    ...
    protected:
        ...
        bool m_skipBreakChance;
        bool m_canDualStack;
        bool m_activeDualStack;
        bool m_forceSingleStack;
        bool m_positive:1;
        bool m_permanent:1;
        bool m_isPeriodic:1;
        bool m_isTrigger:1;
