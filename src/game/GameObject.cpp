        ...
        case GO_READY:
        {
            ...
            if(goInfo->type == GAMEOBJECT_TYPE_TRAP)
            {
                ...
                if(owner && NeedDespawn)                    // hunter trap
                {
                    ...
                    cell.Visit(p, grid_object_checker, *MapManager::Instance().GetMap(GetMapId(), this));
                    ...
                    if(!ok)
                    {
                        ...
                        cell.Visit(p, world_object_checker, *MapManager::Instance().GetMap(GetMapId(), this));
                    }
                }
...
void GameObject::TriggeringLinkedGameObject( uint32 trapEntry, Unit* target)
{
    ...
    GameObject* trapGO = NULL;
    {
        ...
        cell.Visit(p, object_checker, *MapManager::Instance().GetMap(GetMapId(), this));
    }
