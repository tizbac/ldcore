...
class TRINITY_DLL_SPEC Player : public Unit
{
    ...
    public:
        ...
        bool GetComboPointsDelayed() { return m_comboPointsDelayed; }

        void AddComboPoints(Unit* target, int8 count, bool delayed=false);
        void AddComboPointsDelayed(bool val) { m_comboPointsDelayed = val; };
        ...
        void RemoveTargetFromSight(Player* target);
        ...
        {
            m_teleport_dest = WorldLocation(m_homebindMapId, m_homebindX, m_homebindY, m_homebindZ, GetOrientation());
        };

        //ANTICHEAT FUNC//
        bool  AntiCheatIsTeleport()         { return m_isTeleport; }
        void  AntiCheatSetTeleport(bool val){ m_isTeleport = val; }

        float AntiCheatGetLastPosX() { return m_last_x; }
        float AntiCheatGetLastPosY() { return m_last_y; }

        void   AntiCheatKickCount()     { m_countToKick++; }
        uint32 AntiCheatGetKickCount()  { return m_countToKick; }
        void   AntiCheatResetKickCount(){ m_countToKick = 0; }

        uint32 AntiCheatGetResetKickTimer() { return m_resetKickTimer; }
        void   AntiCheatSetResetKickTimer() { m_resetKickTimer = getMSTime(); }

        uint32 AntiCheatGetIgnoreTimer() { return m_lammaCounter; }
        uint32 AntiCheatGetLastTime()    { return m_antiCheatTimer; }
        void AntiCheatUpdateLastTime()   { m_antiCheatTimer = getMSTime();}
        void AntiCheatUpdateIgnoreTimer(){ m_lammaCounter = getMSTime(); }
        void AntiCheatUpdateLastPos()    { m_last_x = GetPositionX(); m_last_y = GetPositionY();}
    ...
    protected:
        ...
        */
        ...
        uint32 m_antiCheatTimer;
        uint32 m_lammaCounter;

        uint32 m_countToKick;
        uint32 m_resetKickTimer;
