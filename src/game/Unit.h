...
class TRINITY_DLL_SPEC Unit : public WorldObject
{
    public:
        ...
        typedef std::map<uint64, bool> DetectionCache;
        ...
        void ClearDetectionCache() { m_DetectionCache.clear(); }
        ...
        void ProcDamageAndSpell(Unit *pVictim, uint32 procAttacker, uint32 procVictim, uint32 procEx, uint32 amount, uint32 cleanAmount, WeaponAttackType attType = BASE_ATTACK, SpellEntry const *procSpell = NULL, bool canTrigger = true);
        void ProcDamageAndSpellFor( bool isVictim, Unit * pTarget, uint32 procFlag, uint32 procExtra, WeaponAttackType attType, SpellEntry const * procSpell, uint32 damage, uint32 cleanDamage = 0);
        ...
        void RemoveSingleAuraFromStackByDispel(uint32 spellId, uint64 casterGUID);
        ...
        bool HasAurasWithInterruptFlags(uint32 flag);
        ...
        virtual bool canDetectStealthOf(Unit const* u, float distance) const;
        ...
        bool IsForceAttack() { return m_forceAttack; };
        void SetForceAttack(bool val) { m_forceAttack = val; };
    ...
    private:
        ...
        bool HandleDummyAuraProc(   Unit *pVictim, uint32 damage, uint32 cleanDamage, Aura* triggredByAura, SpellEntry const *procSpell, uint32 procFlag, uint32 procEx, uint32 cooldown);
        ...
        DetectionCache m_DetectionCache;
