...
extern void _LUARELOAD(CreatureAI * ai);
...
bool ChatHandler::HandleReloadLuaCommand(const char * args)
{
  ...
  {
    PSendSysMessage("|c00ff00ffDevi selezionare un npc che ha una AI in lua!|r");
    return false;
