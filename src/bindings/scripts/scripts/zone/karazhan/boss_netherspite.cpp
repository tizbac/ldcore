...
struct TRINITY_DLL_DECL mob_netherspitevoidzoneAI : public ScriptedAI
{
    mob_netherspitevoidzoneAI(Creature *c) : ScriptedAI(c) {}
...
CreatureAI* GetAI_mob_netherspitevoidzoneAI(Creature *_Creature)
{
    return new mob_netherspitevoidzoneAI (_Creature);
}
void AddSC_boss_netherspite()
{
    ...
    newscript = new Script;
    newscript->Name="mob_netherspitevoidzone";
    newscript->GetAI = &GetAI_mob_netherspitevoidzoneAI;
    newscript->RegisterSelf();
}
